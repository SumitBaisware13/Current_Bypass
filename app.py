...
st.set_page_config(page_title="Bypass Event Dashboard", layout="wide", page_icon="⚡")
st.title("⚡ Current Bypass Event Analytics Dashboard")

# --- Read data ---
df = pd.read_excel("current_bypass_event_19_05_2025.xlsx")
